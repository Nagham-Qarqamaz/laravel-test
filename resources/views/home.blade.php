    ...
    <div class="container">
        <form method="get">
            <div class="row">
                <div class="col-6">
                    <div class="dropdown">
                        <select name="genre" class="btn btn-light dropdown-toggle mb-4 form-select w-50" aria-label="select genre">
                ...
                <div class="input-group mb-3 float-end" style="width: 200px;">
                    <input type="text" name="q" value="{{ request('q') }}" class="form-control" placeholder="search by name" aria-label="Recipient's username" aria-describedby="basic-addon2">
                ...
                <div class="col-lg-4 col-md-6 my-3">
                    <div class="card m-auto text-light bg-dark pt-3 animate__animated animate__fadeIn" style="box-shadow: 5px 5px 20px black; width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row ">
                                <div class="col-6 text-muted">{{ $book->author->name }}</div>
                                <div class="col-6 text-end text-muted">{{ $book->created_at }}</div>
                            </div>
                            ...
                            <div class="row ">
                                ...
                                <div class="col-6 text-end text-muted" id="b-{{ $book->id }}">
                                    {{ $book->likes }}
                                </div>
                            </div>
                        </div>
        ...
        for(let element of reviewButtons) {
            element.addEventListener('click', (e)=>{
                $.ajax({
                    ...
                    document.getElementById(`b-${element.dataset.id}`).innerHTML = data.likes;
                });
            });
        }
    </script>
